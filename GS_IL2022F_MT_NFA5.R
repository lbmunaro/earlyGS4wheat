...
data_list <- list(
  ...
  # 1: MT 22-23YT
  GmaskIL2022F_MT2223 = IL_blues_filtered |>
    filter(Env %in% c('22-Adv','22-Neo','22-Stp','22-Urb',
                      '23-Adv','23-Neo','23-Stp','23-Urb')) |>
    droplevels(),
  
  # 2: MT 22-24YTnTRN
  GmaskIL2022F_MT2224nTRN = IL_blues_filtered |>
    filter(Env %in% c('22-Adv','22-Neo','22-Stp','22-Urb',
                      '23-Adv','23-Neo','23-Stp','23-Urb',
  ...
  # 3: MT 22-24YTnTRN + IL2022F
  GmaskIL2022F_MT2224nTRN_IL2022F = IL_blues_filtered |>
    filter(
  ...
  # 4: MT 22-24YTyTRN
  GmaskIL2022F_MT2224yTRN = IL_blues_filtered |>
    filter(
      Env %in% c('22-Adv','22-Neo','22-Stp','22-Urb',
                 '23-Adv','23-Neo','23-Stp','23-Urb',
                 '24-Urb') |
  ...
  # 5: MT 22-24YTyTRN + IL2022F
  GmaskIL2022F_MT2224yTRN_IL2022F = IL_blues_filtered |>
    filter(
      Env %in% c('22-Adv','22-Neo','22-Stp','22-Urb',
                 '23-Adv','23-Neo','23-Stp','23-Urb',
                 '24-Urb') |
